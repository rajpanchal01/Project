...
User.create!(email: "admin@bacancy.com", password: "admin@123")
...
ProjectMaster.create!(name: "Stock Market App", description: "An app for stock market equities", user_id: 2)